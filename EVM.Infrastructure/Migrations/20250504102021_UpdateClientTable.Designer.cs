...
namespace EVM.Infrastructure.Migrations
{
    ...
    [Migration("20250504102021_UpdateClientTable")]
            ...
            modelBuilder.Entity("EVM.Domain.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Password = "�8�y��^ͪ>�Ǒ\"��-�������X�5����\\��)\0d%�Wy*��e��QU���|o",
                            PhoneNumber = "585-123-4567",
                            Role = "Client",
                            Salt = new Guid("92ac876f-ee41-47dd-9c8b-ca0d38ba3974")
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Name = "Emily Johnson",
                            Password = "x3�xտ��}��B	}��%�i�e��ߓ�	��ؐ��e��Q���=@P�X��/�O���<O}�y",
                            PhoneNumber = "585-123-4567",
                            Role = "Client",
                            Salt = new Guid("e3b55037-3257-421d-9c8c-8276e6a0bca0")
                        },
                        new
                        {
                            Id = 6,
                            ...
                            PhoneNumber = "585-123-4567",
                            Role = "Client",
                            Salt = new Guid("cfe18d0e-3dbb-4bb7-a940-0941bdea2d6d")
                        },
                        new
                        {
                            Id = 7,
                            Email = "mchen@tech.net",
                            Name = "Media Inc.",
                            Password = "�/�/��5�!��o��K��\rp�K�ʆi)�N^�*���r�o����:�st�=~:3�u\n�",
                            PhoneNumber = "585-123-4567",
                            Role = "Client",
                            Salt = new Guid("252dab5a-4508-4750-932e-c558b5bb03ca")
                        },
                        new
                        {
                            Id = 8,
                            ...
                            Password = "��o��=v�_�����Fy��d��H�\nr 3)�!���E~���1�n\\��;�.�9΀�Ne<�g",
                            PhoneNumber = "585-123-4567",
                            Role = "Client",
                            Salt = new Guid("cced3ada-98ea-4cb6-b18c-085cceca338c")
                        });
                });
